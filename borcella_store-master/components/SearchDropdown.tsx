...
const SearchDropdown = ({ query, isVisible, onClose, onSelectProduct }: SearchDropdownProps) => {
  ...
  return (
    <HydrationSafe fallback={
      <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-md border border-gray-200 rounded-lg shadow-xl z-50 max-h-96 overflow-y-auto">
        <div className="p-4">
