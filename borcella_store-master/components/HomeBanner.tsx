  ...
  if (loading) {
    return (
      <section className="w-full bg-gray-100">
        <div className="max-w-[1920px] mx-auto px-2 sm:px-4 md:px-8 py-4 sm:py-8">
    ...
    <section className="w-full bg-gray-100">
      <div className="max-w-[1920px] mx-auto px-2 sm:px-4 md:px-8 py-4 sm:py-8">
        ...
        <div className="relative w-full aspect-video overflow-hidden rounded-2xl shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-4 sm:px-8 md:px-16 lg:px-24">
            <div className="max-w-2xl">
              ...
              <h1 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-2 sm:mb-4 leading-tight">
                Discover Your Style
              </h1>

              <p className="text-base sm:text-lg md:text-xl text-white/90 mb-4 sm:mb-8 max-w-lg leading-relaxed">
                Explore our latest collection of trendy fashion pieces
              </p>

              <button 
                onClick={scrollToCollections}
                className="inline-flex items-center gap-2 bg-white text-black px-6 sm:px-8 py-2 sm:py-4 rounded-full font-semibold 
                  hover:bg-gray-100 transition-all duration-300 shadow-lg transform hover:-translate-y-0.5 
                  active:translate-y-0 group text-sm sm:text-base"
              >
                Shop Now
          ...
          <div className="absolute top-0 left-0 w-16 h-16 sm:w-32 sm:h-32 bg-gradient-to-br from-white/10 to-transparent rounded-br-full" />
          <div className="absolute bottom-0 right-0 w-12 h-12 sm:w-24 sm:h-24 bg-gradient-to-tl from-white/10 to-transparent rounded-tl-full" />
        </div>
      </div>
    </section>
  );
