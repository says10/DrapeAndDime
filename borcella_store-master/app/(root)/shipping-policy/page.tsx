  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50/50 to-gray-100/50 flex items-center justify-center px-4 py-8 sm:px-8 sm:py-16">
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg p-4 sm:p-8 mx-auto">
        ...
        <p className="text-sm sm:text-base text-gray-700 mb-4">SAYANTAN MUKHERJEE is not liable for any delay in delivery by the courier company or postal authorities and only guarantees to hand over the consignment to the courier company or postal authorities within the processing time.</p>
      </div>
    </div>
  );
};
