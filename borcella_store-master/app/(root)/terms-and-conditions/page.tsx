  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50/50 to-gray-100/50 flex items-center justify-center px-4 py-8 sm:px-8 sm:py-16">
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg p-4 sm:p-8 mx-auto">
        <h1 className="text-2xl sm:text-4xl font-bold mb-2 sm:mb-4 text-center">Terms and Conditions</h1>
        <p className="text-xs sm:text-sm text-gray-500 text-center mb-4">Last updated: March 21, 2025</p>
        ...
        <h3 className="text-lg sm:text-2xl font-bold mt-6 mb-2">2. Website Content</h3>
        <p className="text-sm sm:text-base text-gray-700 mb-4">
        ...
        <h3 className="text-lg sm:text-2xl font-bold mt-6 mb-2">3. Use of Information</h3>
        <p className="text-sm sm:text-base text-gray-700 mb-4">
          Your use of any information or materials on our website and/or product pages is entirely at your own risk, for which we shall not be liable. It shall be your own responsibility to ensure that any products, services, or information available through our website and/or product pages meet your specific requirements.
        </p>
        <h3 className="text-lg sm:text-2xl font-bold mt-6 mb-2">4. Intellectual Property</h3>
        <p className="text-sm sm:text-base text-gray-700 mb-4">
        ...
        <h3 className="text-lg sm:text-2xl font-bold mt-6 mb-2">5. Unauthorized Use</h3>
        <p className="text-sm sm:text-base text-gray-700 mb-4">
          Unauthorized use of information provided by us shall give rise to a claim for damages and/or be a criminal offense.
        </p>
        <h3 className="text-lg sm:text-2xl font-bold mt-6 mb-2">6. Third-Party Links</h3>
        <p className="text-sm sm:text-base text-gray-700 mb-4">
        ...
        <h3 className="text-lg sm:text-2xl font-bold mt-6 mb-2">8. Dispute Resolution</h3>
        <p className="text-sm sm:text-base text-gray-700 mb-4">
        ...
        <h3 className="text-lg sm:text-2xl font-bold mt-6 mb-2">9. Contact Us</h3>
        <p className="text-sm sm:text-base text-gray-700 mb-4">
          If you have any questions or concerns regarding these Terms and Conditions, please contact us at <a href="mailto:drapeanddime@gmail.com" className="text-blue-600 hover:underline font-semibold">drapeanddime@gmail.com</a>.
        </p>
      </div>
    </div>
  );
